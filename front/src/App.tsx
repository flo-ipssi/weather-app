...
function App() {
  ...
  const getWeather = async () => {
    try {
      const response = await axios.get(`http://localhost:8003/weather`);
              ...
              <h2 className="text-md mb-2 px-4 pt-4">
                <div className="flex justify-between">
                  <div className="badge relative top-0">
                    <span className="mt-2 py-1 h-12px text-md font-semibold w-12px  rounded right-1 bottom-1 px-4">Laghouat</span></div>
